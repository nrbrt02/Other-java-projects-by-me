 ...
 * @author ZIPTECH LTD
 */
public class ClassessViewTeacher extends javax.swing.JInternalFrame {

    /**
     * Creates new form ClassessViewTeacher
     */
    public ClassessViewTeacher() {
        initComponents();
        allRetrived();
        fillTeacher();
    }
    ...
    void fillTeacher() {
        try {
            ...
            for (Teacher teacher : allTeachers) {
                teacherComb.addItem(teacher.getNames().toString());
            }
        } catch (Exception e) {
            e.printStackTrace();
        }
    ...
    void allRetrived() {
        ...
        try {
            ...
            for (Classs classObj : allClasses) {
                ...
                String teacher_id = classObj.getTheTeacher().getNames();
                tbModel.addRow(new Object[]{
                    id, names, credits, day, time, room, teacher, teacher_id});
            }
        } catch (Exception e) {
            e.printStackTrace();
        }
