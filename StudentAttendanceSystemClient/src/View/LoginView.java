            ...
            try {
                if (isAdmin.isSelected()) {
                    ...
                    if (loggedAdmin.size() == 1) {
                        ...
                        view.loggedEmail.setText(email.getText());
                        view.show();
                        dispose();
                    } else {
                    ...
                    List<Teacher> loggedTeacher = service.loginTeacher(ad);

                    if (loggedTeacher.size() == 1) {
                        TeachersDashboard view = new TeachersDashboard();
                        view.loggedEmail.setText(email.getText());
                        view.show();
                        dispose();
                    } else {
